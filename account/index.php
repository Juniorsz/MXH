...
<head>
    ...
    <title>FSocial ( @<?php echo $username ?> )</title>
    <!-- UIkit CSS -->
...
<body>
  ...
  <div class="main-container">
     <div class="uk-text-center" uk-grid>
        <div class="uk-width-expand@m">
          ...
          <div class="main-newsfeed">
             <?php 
                $username =  addslashes(trim(htmlspecialchars($_GET['u'])));
                $data->user($username); 
              ?>
          </div>
          <!-- End news -->
    ...
    <script>
      function displayDataAccount(){$.ajax({url:'../Controller/controller.php',method:'POST',data:{action:'displayDataAccount',user:'<?php echo $username ?>'},success:function(data){$('.main-newsfeed').html(data)}})};
    </script>
